 ...
 * Displays a friendly error UI when errors occur in the app
 * This is a client component that catches errors in the app tree
 */
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="max-w-md w-full glass-dark rounded-3xl p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="/"
            className="px-6 py-3 bg-white border-2 border-gold text-gold font-bold rounded-xl hover:bg-gold hover:text-gray-900 transition-all text-center"
          >
            Go Home
          </Link>
        </div>
