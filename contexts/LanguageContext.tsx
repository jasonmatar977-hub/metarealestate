...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'journal.title': 'Area Journal',
    'journal.subtitle': 'Real-time market insights for Beirut neighborhoods',
    'journal.hubTitle': 'Beirut Area Journal',
    'journal.hubSubtitle': 'Stay informed about market trends, prices, and opportunities',
    'journal.lastUpdated': 'Last updated',
    'journal.openJournal': 'Open Journal',
    'journal.snapshot': 'Snapshot (30-sec read)',
    'journal.status': 'Status',
    'journal.demand': 'Demand',
    'journal.inventoryTrend': 'Inventory Trend',
    'journal.priceFlexibility': 'Price Flexibility',
    'journal.priceReality': 'Price Reality',
    'journal.rentRanges': 'Rent Ranges',
    'journal.saleRange': 'Sale Range',
    'journal.perSqm': 'per sqm',
    'journal.drivingFactors': "What's driving the area now",
    'journal.risks': 'Risks & Watch-outs',
    'journal.outlook': '90-Day Outlook',
    'journal.outlookUp': 'Up',
    'journal.outlookSideways': 'Sideways',
    'journal.outlookDown': 'Down',
    'journal.whatWouldChange': 'What would change this view',
    'journal.localNotes': 'Local Notes',
    'journal.fromVerifiedContributors': 'from verified contributors',
    'journal.methodology': 'Methodology',
    'journal.lastUpdatedLabel': 'Last updated',
    'journal.relatedListings': 'Related Listings',
    'journal.askAI': 'Ask AI about this area',
    'journal.discussArea': 'Discuss this area',
    'journal.methodologyTitle': 'How We Write Area Journals',
    'journal.methodologySubtitle': 'Transparent, fact-based market analysis',
    'journal.heating': 'Heating',
    'journal.cooling': 'Cooling',
    'journal.stable': 'Stable',
    'journal.loading': 'Loading areas...',
    'journal.noAreas': 'No areas available',
    'journal.error': 'Error loading areas',
  },
  ar: {
